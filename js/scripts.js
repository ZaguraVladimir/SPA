...
var spa = (function ($) {// Помещаем весь наш код в пространство имен "spa"
    ...
    toggleSlider = function () {
        ...
        //Сравним текущую высоту окна с максимальной, чтобы понять, раскрыто ли оно полностью.
        //Если это так, то с помощью имеющегося в jQuery механизма анимации свернем его.          
